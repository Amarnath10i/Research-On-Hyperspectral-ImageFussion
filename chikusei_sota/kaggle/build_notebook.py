...
REPO = "https://github.com/Amarnath10i/research-on-hyperspectral--image-fusion.git"


def cells(commit, hours, width, stages, bs):
    run = lambda cmd: (
        "import subprocess, sys\n"
        f"p = subprocess.Popen({cmd!r}, shell=True, cwd='/kaggle/working/repo/chikusei_sota',\n"
