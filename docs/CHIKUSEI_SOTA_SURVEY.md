# Chikusei HSI–MSI Fusion: State of the Art 

All numbers below come from the tables in the 10 papers read for this survey (kept locally in the gitignored `literature/chikusei_papers/`),
...
`literature/chikusei_papers/`, and bulk download from IEEE Xplore was not possible from
this session.
