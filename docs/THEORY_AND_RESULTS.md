# Theory and Results: Identifiability, Ambiguity, and Sensor-Shift Theory

> Detailed write-up of the theory track (P1–P4, KrylovNet, NullFusion). For the repository
> overview and the current Chikusei SOTA work, see the [main README](../README.md).
...
- Kernel: `sandeepchowdary2005/sota-krylovnet-houston-nikon` (or `methods/nullfusion/notebooks/nullfusion_SOTA_CAVE_Nikon.ipynb`)
